...
?>
        ...
        <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h1>Concepto de Gastos</h1>
                                </div>
                                <div class="col-sm-6">
                                    <ol class="breadcrumb float-sm-right">
                                        <li class="breadcrumb-item"><a href="../../menu.php">Home</a></li>
                                        <li class="breadcrumb-item active">Concepto de Gastos</li>
                                    </ol>
                                </div>
                            </div>
                        </div><!-- /.container-fluid -->
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_gastos">
                                                <i class="fa fa-book"></i> Nuevo Ingreso
                                            </button>
                                            <hr>
                                            <table class="table table-bordered table-hover" id="tbl_lista_gastos" style="width: 100%;" cellspacing="0">
                                                <thead>
                                                    <tr>
                                                        <th>Descripcion</th>
                                                        <th>Estado</th>
            ...
            <!-- MODAL INGRESO-->
            <div class="modal fade" id="modal_gastos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
                data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog">
                    <form id="ing_gasto">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ingreso nuevo Gasto</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12 col-sm-12">
                                        ...
                                        <input type="text" id="gasto" class="form-control" placeholder="Gasto">
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Modal de editar-->
            <div class="modal fade" id="modal_gastos_E" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
                data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog">
                    <form id="Edit_gasto">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Editar Nombre Gasto</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-6 col-sm-6">
                                        <label>Nombre Gasto</label>
                                        <input type="hidden" id="Idgasto_E">
                                        <input type="text" id="gasto_E" class="form-control" placeholder="Gasto">
                                    </div>
                                    <div class="col-6 col-sm-6">
                                        <label>Estado</label>
            ...
            <script>
                $(document).ready(function() {
                    listar_Gastos();
                    $("#Edit_gasto").submit(function(e) {
                        e.preventDefault();
                        var Idgasto_E = $("#Idgasto_E").val();
                        var gasto_E = $("#gasto_E").val();
                        var slEstado_E = $("#slEstado_E").val();
                        if (gasto_E == '') {
                            Swal.fire({
                                icon: 'warning',
                                title: "Ingrese el Nombre del Gasto",
                ...
                function cargar_lista_gastos(data) {
                    var table = $('#tbl_lista_gastos').DataTable();
                    table.destroy();
                    table.clear();
                    $('#tbl_lista_gastos').dataTable({
                        "order": [
                            [1, 'DESC']
                        ],
                        "language": {
                    ...
                    $('#tbl_lista_gastos tbody').on('click', 'button.eliminar', function() {
                        event.preventDefault();
                        var table = $('#tbl_lista_gastos').DataTable();
                        var data = table.row($(this).parents('tr')).data();
                        var estado = $(this).parents("tr").find('#spEstado');
                        var idgastoEliminar = data.Id;
                        Swal.fire({
                            title: "Estas Seguro ?",
                            text: "De eliminar este Gasto !",
                            icon: "warning",
                            ...
                            if (result.isConfirmed) {
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        idgastoEliminar: idgastoEliminar
                                    },
                                    success: function(data) {
                                        if (data.success) {
                                            Swal.fire({
                    ...
                    $('#tbl_lista_gastos tbody').on('click', 'button.editar', function() {
                        event.preventDefault();
                        var table = $('#tbl_lista_gastos').DataTable();
                        var data = table.row($(this).parents('tr')).data();
                        var estado = $(this).parents("tr").find('#spEstado');
                        $("#modal_gastos_E").modal('show');
                        gasto_E = $("#gasto_E").val(data.Nombre);
                        Idgasto_E = $("#Idgasto_E").val(data.Id);
